...
public class RenegociacaoPagamentosApplication {
    ...
    public CommandLineRunner demoData(BoletoRepository boletoRepository) {
        return args -> {
            // Apaga todos os boletos existentes no banco
            System.out.println("Limpando dados de boletos existentes...");
            boletoRepository.deleteAll();
            System.out.println("Todos os boletos foram removidos do banco de dados");
